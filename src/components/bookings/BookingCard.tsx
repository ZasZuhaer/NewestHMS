...
<>
  ...
  <button onClick={handleCheckIn} className="btn btn-primary w-38">Check In</button>

  {(userRole === 'admin' || userRole === 'manager') && (
    <button onClick={handleCancellation} className="btn btn-danger w-38" disabled={!!cancellationRequest?.status === 'pending'}>
