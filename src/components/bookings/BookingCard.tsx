...
<>
  <div className="flex w-full justify-between items-center">
    ...
    <div className="flex flex-col gap-1">
      ...
      <h3 className="text-lg font-semibold">{roomNumber ?? booking.roomId}</h3>
  ...
  <button onClick={handleCheckIn} className="btn btn-primary w-48">Check In</button>

  {(userRole === 'admin' || userRole === 'manager') && (
    <button onClick={handleCancellation} className="btn btn-danger w-48" disabled={!!cancellationRequest?.status === 'pending'}>
