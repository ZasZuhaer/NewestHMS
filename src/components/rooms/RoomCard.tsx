...
const RoomCard: React.FC<RoomCardProps> = ({ room, currentBooking, onClick, isAvailable }) => {
  ...
  return (
    <div 
      className={`card card-hover border ${getStatusColor()} p-1.5`}
      onClick={onClick}
      role="button"
      tabIndex={0}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <h3 className="ml-1 text-sm 2xl:text-base font-semibold whitespace-nowrap">
Room {room.roomNumber}</h3>
      ...
      {currentBooking && (
        <div className="pt-2">
          ...
          <div className="ml-1 mr-1 flex justify-between text-xs text-gray-500 mt-1">
            <span>
