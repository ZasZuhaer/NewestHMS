    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <h3 className="text-sm md:text-base font-semibold whitespace-nowrap">
Room {room.roomNumber}</h3>
          ...
          <div className="flex items-center space-x-3">
            <span className="text-[10px] lg:text-xs font-medium bg-blue-100 text-blue-800 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
              {room.category}
            </span>
