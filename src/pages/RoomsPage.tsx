    ...
    <div className="space-y-6">
      ...
      {isAdmin && (
        <button
          ...
          className="fixed bottom-6 right-12 z-50 inline-flex items-center px-4 py-2 rounded-full shadow-2xl text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
        >
